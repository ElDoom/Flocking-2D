...
public class CompositeBehaviorEditor : Editor
{
    public override void OnInspectorGUI()
    {
        ...
        else
        {
            ...
            for (int i = 0; i < cb.behaviors.Length; i++)
            {
                ...
                cb.behaviors[i] = (Boid_Behaviour)EditorGUILayout.ObjectField(cb.behaviors[i], typeof(Boid_Behaviour), false, GUILayout.MinWidth(60f));
    ...
    void AddBehavior(CompositeBehavior cb)
    {
        ...
        Boid_Behaviour[] newBehaviors = new Boid_Behaviour[oldCount + 1];
